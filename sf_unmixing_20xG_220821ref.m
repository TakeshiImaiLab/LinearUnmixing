function [unmixData]=sf_unmixing_20xG_220821ref(fn)
% load xycz image
...
%for ex405nm
ref405=[1	0.147420138	0.007326819
0.912514904	1	0.020330735
0.23378902	0.593128613	1];
InvRef405=inv(ref405);
%for ex488nm
ref488=[1	0.794050287
0.410730625	1];
InvRef488=inv(ref488);
%for ex552nm
ref552=[1	0.124504952
1.239170915	1];
